...
//    }
    ...
    public VectorStore vectorStore() {
        ...
        int dimensions = (embeddingModel instanceof OpenAiEmbeddingModel) ? 1536 : 1024; // OpenAI: 1536, Ollama: 1024
    ...
    private EmbeddingModel determineEmbeddingModel() {
        if (StringUtils.hasText(openAiApiKey) && openAiEmbeddingModel != null) {
            ...
            throw new IllegalStateException("No embedding model available. Please configure either OpenAI or Ollama.");
        }
    }
}
